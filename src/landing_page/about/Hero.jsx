    ...
    return ( 
        ...
        <div className="container mt-5 p-5">
            <div className="row p-4 text-center ">
                <h1 className="fs-2 pb-5 lh-base">We pioneered the discount broking model in India. <br />
            ...
            <div className="row mt-5 ms-5">
                ...
                <div className="col-6  ">
                    ...
                    <p> <a href="https://rainmatter.com/">Rainmatter</a>, our fintech fund and incubator, has invested <br /> in several fintech startups with the goal of growing the <br /> Indian capital markets.</p>
                    <p>And yet, we are always up to something new every day. <br /> Catch up on the latest updates on our <a href="https://zerodha.com/z-connect/">blog</a> or see what <br /> the media is <a href="https://zerodha.com/media">saying about us</a>.</p>
                </div>
            </div>
        </div>
        </>
